...
import { JobHistoryFormValues, jobHistorySchema, JobHistoryWithDetails } from "../types/JobHistoryTypes";

interface EditJobHistoryFormProps {
...
const EditJobHistoryForm = ({
  ...
  const form = useForm<JobHistoryFormValues>({
    ...
    defaultValues: {
      ...
      salary: currentJobHistory?.salary || 0,
    },
  });
...
export default EditJobHistoryForm;
